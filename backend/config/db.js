...
try {
  ...
  logger.warn("Failed to set custom DNS servers, SRV resolution might fail:", err.message);
}
  ...
  const connectWithRetry = async () => {
    try {
      ...
      if (retryCount < MAX_RETRIES) {
        ...
        logger.error(
          "Max retry attempts reached. Server will operate without database connection.",
        );
      }
    }
  };
